...
import { Smartphone, Monitor, Users, CheckCircle } from 'lucide-react';
        ...
        <section className="relative min-h-[70vh] sm:min-h-[60vh] lg:min-h-[80vh] flex items-center justify-center overflow-hidden">
          ...
          <div className="relative z-10 container mx-auto px-4 text-center py-8 sm:py-12">
            ...
            <p className="text-base sm:text-xl lg:text-2xl text-white/90 max-w-4xl mx-auto mb-6 sm:mb-8 px-2 sm:px-4 leading-relaxed">
              Design intuitive user interfaces and experiences that engage users and drive conversions
            </p>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center mb-16">
            <div>
              ...
              <p className="text-eastdigital-lightgray mb-6 leading-relaxed text-lg">
                We create intuitive and engaging user interfaces that prioritize user experience while achieving your business goals. Our design process is rooted in user research, testing, and iterative improvement to ensure optimal results.
              </p>
              <ul className="space-y-3 text-eastdigital-lightgray">
                <li className="flex items-start">
                  ...
                  <span>Comprehensive user research and analysis</span>
                </li>
                <li className="flex items-start">
                  <CheckCircle className="h-5 w-5 text-eastdigital-orange mt-1 mr-3 flex-shrink-0" />
                  <span>Wireframing and interactive prototyping</span>
                </li>
                <li className="flex items-start">
                  <CheckCircle className="h-5 w-5 text-eastdigital-orange mt-1 mr-3 flex-shrink-0" />
            ...
            <div className="bg-gray-900/50 backdrop-blur-sm border border-gray-800 rounded-2xl p-8">
              <Smartphone className="h-12 w-12 text-eastdigital-orange mb-6" />
              <h3 className="text-2xl font-bold text-white mb-4">Design Deliverables</h3>
              <ul className="space-y-3 text-eastdigital-lightgray">
                <li>• User journey maps and personas</li>
        ...
        <section className="container mx-auto px-4 py-16" style={{ backgroundColor: '#222222' }}>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-gray-900/50 backdrop-blur-sm border border-gray-800 rounded-xl p-8 text-center">
              ...
              <h3 className="text-xl font-bold text-white mb-4">User-Centered Research</h3>
              <p className="text-eastdigital-lightgray">
                We start every project by understanding your users' needs, behaviors, and pain points through comprehensive research.
              </p>
            </div>
            <div className="bg-gray-900/50 backdrop-blur-sm border border-gray-800 rounded-xl p-8 text-center">
              <Monitor className="h-12 w-12 text-eastdigital-orange mx-auto mb-4" />
              <h3 className="text-xl font-bold text-white mb-4">Iterative Design</h3>
              <p className="text-eastdigital-lightgray">
                Our iterative process involves continuous testing and refinement to ensure the best possible user experience.
              </p>
            </div>
            <div className="bg-gray-900/50 backdrop-blur-sm border border-gray-800 rounded-xl p-8 text-center">
              <Smartphone className="h-12 w-12 text-eastdigital-orange mx-auto mb-4" />
              <h3 className="text-xl font-bold text-white mb-4">Responsive Excellence</h3>
              <p className="text-eastdigital-lightgray">
                Every design is optimized for all devices and screen sizes, ensuring consistent experiences across platforms.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="container mx-auto px-4 py-16" style={{ backgroundColor: '#141414' }}>
          <div className="text-center">
            ...
            <p className="text-xl text-eastdigital-lightgray mb-8 max-w-2xl mx-auto">
              Let's design intuitive interfaces that delight your users and drive meaningful engagement with your digital products.
            </p>
