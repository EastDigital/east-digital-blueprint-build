...
export const HeroContent = () => {
  return (
    <div className="text-left sm:text-center max-w-5xl mx-auto px-[15px] py-[40px]">
      <p style={{ fontSize: '18px' }} className="text-white font-poppins font-thin tracking-[1px] py-0">
        Real Estate Developers
      </p>
      
      <h1 className="text-[32px] leading-[1.1] sm:text-4xl md:text-6xl lg:text-7xl font-bold mb-4 sm:mb-6 md:mb-8 text-white font-poppins mt-3 sm:mt-4 md:mt-6 py-0">
        Drive Sales<br />
      ...
      <p style={{ color: '#FFE0CA' }} className="text-sm sm:text-base md:text-lg max-w-3xl sm:mx-auto mb-3 sm:mb-8 md:mb-8 font-poppins font-light leading-relaxed py-0">
