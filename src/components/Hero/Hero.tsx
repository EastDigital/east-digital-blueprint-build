  ...
  return (
    <section className="relative min-h-screen bg-eastdigital-dark overflow-hidden flex flex-col">
      ...
      <div className="relative z-10 container mx-auto px-2 sm:px-4 flex flex-col min-h-screen">
        {/* Top Row - Content with significantly reduced mobile padding */}
        <div className="flex-1 flex items-center justify-center py-2 sm:py-4 md:py-16">
          <HeroContent />
        </div>
        
        {/* Bottom Row - Carousel with minimal bottom padding on mobile */}
