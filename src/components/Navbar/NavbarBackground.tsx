...
export const NavbarBackground = ({ isHomePage }: NavbarBackgroundProps) => {
  ...
  return (
    <div className="fixed top-0 left-0 right-0 h-[300px] pointer-events-none z-40">
      ...
      {/* FIXED: This div creates a seamless fade to the main background color.
        It starts transparent and fades to the solid 'eastdigital-dark' color,
        perfectly hiding the bottom edge of the 300px container.
      */}
      <div className="absolute bottom-0 left-0 right-0 h-32 bg-gradient-to-b from-transparent to-eastdigital-dark"></div>
    </div>
  );
};