...
export const AboutSection = () => {
  ...
  return (
    <section className="relative py-20 lg:py-32 bg-eastdigital-dark overflow-hidden">
      ...
      <div className="absolute inset-0 opacity-5 pointer-events-none">
        ...
        <div className="absolute bottom-20 left-10 w-32 h-32 bg-gradient-to-tr from-eastdigital-orange/15 to-transparent rounded-full blur-2xl animate-pulse" style={{ animationDelay: '3s' }}></div>
      </div>
      ...
      <div className="relative z-10 container mx-auto px-4">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 lg:gap-10 mb-16">
          {approaches.map((approach, index) => (
            <div 
              key={index}
              className="group relative bg-gradient-to-br from-gray-900/50 to-gray-800/30 backdrop-blur-sm border border-gray-800/50 rounded-2xl p-8 hover:border-eastdigital-orange/30 transition-all duration-300 hover:transform hover:scale-105"
            >
              {/* Icon */}
