...
export const AboutSection = () => {
  ...
  return (
    <section className="relative bg-gradient-to-b from-black via-zinc-950 to-black overflow-hidden py-0 lg:py-[100px]">
      ...
      <div className="absolute inset-0 opacity-35">
        ...
        <div className="absolute bottom-20 left-10 w-80 h-80 bg-gradient-to-tl from-blue-500/8 via-eastdigital-orange/5 to-white/3 rounded-full blur-4xl animate-pulse" style={{ animationDelay: '3s' }}>
      ...
      <div className="relative z-10 container mx-auto px-4">
        ...
        <div className="text-center">
          <h3 className="text-2xl lg:text-3xl font-bold text-white mb-4 drop-shadow-xl">
            Ready to Experience Our Approach?
          </h3>
          <p className="text-eastdigital-lightgray mb-8 max-w-2xl mx-auto opacity-90">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <LiquidGlassButton 
              variant="primary" 
              size="lg"
              className="px-8 py-3 text-lg font-medium shadow-lg hover:shadow-xl hover:shadow-eastdigital-orange/20 transition-shadow duration-300"
            >
              Get Your Blueprint
            </LiquidGlassButton>
            <LiquidGlassButton 
              variant="secondary" 
              size="lg"
              className="px-8 py-3 text-lg font-medium shadow-lg hover:shadow-xl hover:shadow-white/10 transition-shadow duration-300"
            >
              View Our Process
            </LiquidGlassButton>
          </div>
